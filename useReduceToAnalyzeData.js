...
var averageRating = watchList.reduce(function(avg, rating) {
    let intRating = parseFloat(watchList.imdbRating);
    return avg  + intRating;
    
    // let intRating = parseInt(watchList.imdbRating);
    // return intRating; 
});
